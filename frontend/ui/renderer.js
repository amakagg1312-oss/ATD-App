...
const PLAYER_COLS = {
  ...
  Misc: [
    { key: "GP", label: "GP", fmt: "int" },
    { key: "MIN", label: "MIN", fmt: "dec1" },
    { key: "PTS_OFF_TOV", label: "PTS/TOV", fmt: "dec1" },
    { key: "PTS_2ND_CHANCE", label: "PTS/2ND", fmt: "dec1" },
    { key: "PTS_FB", label: "PTS/FB", fmt: "dec1" },
    { key: "PTS_PAINT", label: "PTS/PAINT", fmt: "dec1" },
    { key: "OPP_PTS_OFF_TOV", label: "OPP/TOV", fmt: "dec1" },
    { key: "OPP_PTS_2ND_CHANCE", label: "OPP/2ND", fmt: "dec1" },
    { key: "OPP_PTS_FB", label: "OPP/FB", fmt: "dec1" },
    { key: "OPP_PTS_PAINT", label: "OPP/PAINT", fmt: "dec1" },
    { key: "BLK", label: "BLK", fmt: "dec1" },
  ...
  Defense: [
    ...
    { key: "OPP_PTS_FB", label: "OPP/FB", fmt: "dec1" },
    { key: "OPP_PTS_PAINT", label: "OPP/PAINT", fmt: "dec1" },
    { key: "DEF_WS", label: "DEF WS", fmt: "dec1" },
  ],
};
...
const TRACKING_COLS = {
  ...
  PullUpShot: [
    ...
    { key: "PULL_UP_FG3M", label: "3PM", fmt: "dec1" }, { key: "PULL_UP_FG3A", label: "3PA", fmt: "dec1" }, { key: "PULL_UP_FG3_PCT", label: "3P%", fmt: "pct" },
  ...
  CatchShoot: [
    ...
    { key: "CATCH_SHOOT_FG3M", label: "3PM", fmt: "dec1" }, { key: "CATCH_SHOOT_FG3A", label: "3PA", fmt: "dec1" }, { key: "CATCH_SHOOT_FG3_PCT", label: "3P%", fmt: "pct" },
    { key: "CATCH_SHOOT_PTS", label: "PTS", fmt: "dec1" }, { key: "CATCH_SHOOT_EFG_PCT", label: "eFG%", fmt: "pct" },
  ],
  PostTouch: [
    { key: "GP", label: "GP", fmt: "int" }, { key: "MIN", label: "MIN", fmt: "dec1" },
    { key: "POST_TOUCHES", label: "TOUCHES", fmt: "dec1" },
    { key: "POST_TOUCH_FGM", label: "FGM", fmt: "dec1" }, { key: "POST_TOUCH_FGA", label: "FGA", fmt: "dec1" }, { key: "POST_TOUCH_FG_PCT", label: "FG%", fmt: "pct" },
    { key: "POST_TOUCH_FTM", label: "FTM", fmt: "dec1" }, { key: "POST_TOUCH_FTA", label: "FTA", fmt: "dec1" }, { key: "POST_TOUCH_FT_PCT", label: "FT%", fmt: "pct" },
    { key: "POST_TOUCH_PTS", label: "PTS", fmt: "dec1" }, { key: "POST_TOUCH_PTS_PCT", label: "PTS%", fmt: "pct" },
    { key: "POST_TOUCH_AST", label: "AST", fmt: "dec1" }, { key: "POST_TOUCH_TOV", label: "TOV", fmt: "dec1" }, { key: "POST_TOUCH_FOULS", label: "PF", fmt: "dec1" },
  ],
  ElbowTouch: [
    { key: "GP", label: "GP", fmt: "int" }, { key: "MIN", label: "MIN", fmt: "dec1" },
    { key: "ELBOW_TOUCHES", label: "TOUCHES", fmt: "dec1" },
    { key: "ELBOW_TOUCH_FGM", label: "FGM", fmt: "dec1" }, { key: "ELBOW_TOUCH_FGA", label: "FGA", fmt: "dec1" }, { key: "ELBOW_TOUCH_FG_PCT", label: "FG%", fmt: "pct" },
    { key: "ELBOW_TOUCH_FTM", label: "FTM", fmt: "dec1" }, { key: "ELBOW_TOUCH_FTA", label: "FTA", fmt: "dec1" }, { key: "ELBOW_TOUCH_FT_PCT", label: "FT%", fmt: "pct" },
    { key: "ELBOW_TOUCH_PTS", label: "PTS", fmt: "dec1" }, { key: "ELBOW_TOUCH_PTS_PCT", label: "PTS%", fmt: "pct" },
    { key: "ELBOW_TOUCH_AST", label: "AST", fmt: "dec1" }, { key: "ELBOW_TOUCH_TOV", label: "TOV", fmt: "dec1" }, { key: "ELBOW_TOUCH_FOULS", label: "PF", fmt: "dec1" },
  ],
  PaintTouch: [
    { key: "GP", label: "GP", fmt: "int" }, { key: "MIN", label: "MIN", fmt: "dec1" },
    ...
    { key: "PAINT_TOUCH_AST", label: "AST", fmt: "dec1" }, { key: "PAINT_TOUCH_TOV", label: "TOV", fmt: "dec1" }, { key: "PAINT_TOUCH_FOULS", label: "PF", fmt: "dec1" },
  ],
  Passing: [
    { key: "GP", label: "GP", fmt: "int" }, { key: "MIN", label: "MIN", fmt: "dec1" },
    ...
    { key: "AST_POINTS_CREATED", label: "AST PTS", fmt: "dec1" },
...
const HUSTLE_COLS = [
  { key: "G", label: "GP", fmt: "int" }, { key: "MIN", label: "MIN", fmt: "dec1" },
  ...
  { key: "OFF_BOXOUTS", label: "OFF BOX", fmt: "dec1" },
  { key: "DEF_BOXOUTS", label: "DEF BOX", fmt: "dec1" },
