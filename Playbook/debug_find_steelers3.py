"""Search for 'Steelers' substring in memory (ASCII and UTF-16LE)."""
...
def main():
    ...
    # Search for 'Steelers' in ASCII and UTF-16LE
    ascii_bytes = b'Steelers'
    utf16_bytes = 'Steelers'.encode('utf-16le')
